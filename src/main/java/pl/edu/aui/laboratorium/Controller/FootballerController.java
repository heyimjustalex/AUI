...
public class FootballerController {
    ...
    @PostMapping
    public ResponseEntity<Void> createLamp(@RequestBody CreateFootballerRequest request, UriComponentsBuilder builder){
        Footballer footballer = CreateFootballerRequest
                .dtoToEntityMapper(test-> footballerService.find(test).orElseThrow())
                .apply(request);
